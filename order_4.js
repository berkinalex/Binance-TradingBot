...
function orden4() {
	...
	precio_orden_4 = document.getElementById("precio_orden_4").value;
	stop_orden_4 = document.getElementById("stop_orden_4").value;
	limite_orden_4 = document.getElementById("limite_orden_4").value;
	cantidad_orden_4 = document.getElementById("cantidad_orden_4").value;
	if (document.getElementById("sa_4").value == "ninguno") {
		alert("¡ No has seleccionado ningún tipo de orden !");
	} else if (document.getElementById("sa_4").value == "comprar_limit_order") {
		binance.buy(cripto, cantidad_orden_4, precio_orden_4, {
			type: "LIMIT"
		}, (error, response) => {
			if (error) {
				alert("Error al realizar la orden #4, comprueba que dispones de saldo suficiente para realizar la orden (pruebe a reducir unas monedas).");
			} else {
				...
				var interval_4 = setInterval(function () {
					binance.orderStatus(cripto, orderid, function (error, json) {
						if (error) {
							...
							estado = json.status;
							if (estado === "FILLED") {
								$('#orden_4').html("Completada");
								if (document.getElementById("sa_5").value != "ninguno") {
									orden5();
								...
								document.getElementById("orden_4").style.color = "#ff0000";
								$('#orden_4').html("Cancelada");
								clearInterval(interval_4);
								if (localStorage.getItem("Alarmas") == "Si") {
									alarma_1.play();
									alarma_1.onended = function () {
	...
	} else if (document.getElementById("sa_4").value == "comprar_orden_de_mercado") {
		binance.marketBuy(cripto, cantidad_orden_4, {
			type: "MARKET"
		}, (error, response) => {
			if (error) {
				alert("Error al realizar la orden #4, comprueba que dispones de saldo suficiente para realizar la orden (pruebe a reducir unas monedas).");
	...
	} else if (document.getElementById("sa_4").value == "comprar_stop_limit") {
		binance.buy(cripto, cantidad_orden_4, precio_orden_4, {
			stopPrice: stop_orden_4,
	...
	} else if (document.getElementById("sa_4").value == "comprar_stop_limit2") {
		binance.buy(cripto, cantidad_orden_4, precio_orden_4, {
			stopPrice: stop_orden_4,
	...
	} else if (document.getElementById("sa_4").value == "comprar_oco") {
		binance.buy(cripto, cantidad_orden_4, precio_orden_4, {
			stopLimitPrice: limite_orden_4,
			stopPrice: stop_orden_4,
			type: "OCO"
		}, (error, response) => {
			if (error) {
	...
	} else if (document.getElementById("sa_4").value == "vender_limit_order") {
		binance.sell(cripto, cantidad_orden_4, precio_orden_4, {
			type: "LIMIT"
		}, (error, response) => {
			if (error) {
				alert("Error al realizar la orden #4, comprueba que dispones de saldo suficiente para realizar la orden (pruebe a reducir unas monedas).");
	...
	} else if (document.getElementById("sa_4").value == "vender_orden_de_mercado") {
		binance.marketSell(cripto, cantidad_orden_4, {
			type: "MARKET"
		}, (error, response) => {
			if (error) {
				alert("Error al realizar la orden #4, comprueba que dispones de saldo suficiente para realizar la orden (pruebe a reducir unas monedas).");
	...
	} else if (document.getElementById("sa_4").value == "vender_stop_limit") {
		binance.sell(cripto, cantidad_orden_4, precio_orden_4, {
			stopPrice: stop_orden_4,
			type: "STOP_LOSS_LIMIT"
		}, (error, response) => {
	...
	} else if (document.getElementById("sa_4").value == "vender_stop_limit2") {
		binance.sell(cripto, cantidad_orden_4, precio_orden_4, {
			stopPrice: stop_orden_4,
			type: "TAKE_PROFIT_LIMIT"
		}, (error, response) => {
	...
	} else if (document.getElementById("sa_4").value == "vender_oco") {
		binance.sell(cripto, cantidad_orden_4, precio_orden_4, {
			stopLimitPrice: limite_orden_4,
			stopPrice: stop_orden_4,
			type: "OCO"
